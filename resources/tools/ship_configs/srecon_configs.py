TER_PEGASUS = {
    "Ship info": {
        "variables": {
            "displayedName": '"GTF Pegasus"',
            "sobDescription": '"Stealth Recon"',
        },
        "functions": [],
    },
    "Health and Armour": {
    ...
    "Weapons": {
        ...
        "functions": [
            ...
            {
                "name": "StartShipWeaponConfig",
                "args": ["miss_stilettoII", "Weapon_Missile2", ""],
            },
        ],
    },
    "Engines": {
