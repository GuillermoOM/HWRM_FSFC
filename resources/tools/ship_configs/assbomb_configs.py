TER_URSA = {
    "Ship info": {
        "variables": {
            "displayedName": '"GTB Ursa"',
            "sobDescription": '"Assault Bomber"',
        },
        "functions": [],
    },
    "Health and Armour": {
...
SHI_NEPHILIM = {
    ...
    "Weapons": {
        ...
        "functions": [
            ...
            {
                "name": "StartShipWeaponConfig",
                "args": ["gun_shivlightlaser_turret", "Weapon_Turret1", ""],
            },
            {
                "name": "StartShipWeaponConfig",
                "args": ["gun_shivlightlaser_turret", "Weapon_Turret2", ""],
            },
            {
                "name": "StartShipWeaponConfig",
                "args": ["miss_pihrana", "Weapon_Bomb1", ""],
            },
            {
                "name": "StartShipWeaponConfig",
                "args": ["miss_shivbomb", "Weapon_Bomb2", ""],
            },
            {
                "name": "StartShipWeaponConfig",
                "args": ["miss_shivmegabomb", "Weapon_Bomb3", ""],
            },
        ],
    },
    "Shields": {
...
SHI_SERAPHIM = {
    ...
    "Supply": {
        "variables": {},
        "functions": [{"name": "setSupplyValue", "args": ["Bomber", "3.0"]}],
    },
    "Tactics And Multipliers": {
        "variables": {"defaultROE": '"Defensive"', "defaultStance": '"Aggressive"'},
        "functions": [
    ...
    "Weapons": {
        ...
        "functions": [
            ...
            {
                "name": "StartShipWeaponConfig",
                "args": ["gun_shivlightlaser", "Weapon_Gun2", ""],
            },
            {
                "name": "StartShipWeaponConfig",
                "args": ["gun_shivlightlaser", "Weapon_FrontGun3", ""],
            },
            {
                "name": "StartShipWeaponConfig",
                "args": ["gun_shivlightlaser_turret", "Weapon_Turret1", ""],
            ...
            {
                "name": "StartShipWeaponConfig",
                "args": ["miss_shivmegabomb", "Weapon_Bomb1", ""],
            },
            {
                "name": "StartShipWeaponConfig",
            ...
            {
                "name": "StartShipWeaponConfig",
                "args": ["miss_trebuchet", "Weapon_Bomb1", ""],
            },
        ],
    },
    "Shields": {
