TER_FAUSTUS = {
    "Ship info": {
        "variables": {
            "displayedName": '"GTSC Faustus"',
            "sobDescription": '"Science Vessel"',
        },
        "functions": [],
    },
    "Health and Armour": {
    ...
    "Supply": {
        ...
        "functions": [
            ...
            {"name": "setSupplyValue", "args": ["Faustus", "1.0"]},
        ],
    },
    "Ship Counter Rating": {
        "variables": {
...
VAS_IMHOTEP = {
    ...
    "Movement": {
        "variables": {
            "mass": "27500",
            "thrusterMaxSpeed": "180",
            "mainEngineMaxSpeed": "180",
            "rotationMaxSpeed": "40",
            "thrusterAccelTime": "7",
            "thrusterBrakeTime": "2",
            "mainEngineAccelTime": "8",
    ...
    "Weapons": {
        ...
        "functions": [
            ...
            {
                "name": "StartShipWeaponConfig",
                "args": ["miss_fighterkiller", "Weapon_Top", ""],
            },
            {
                "name": "StartShipWeaponConfig",
                "args": ["gun_avenger_gimble", "Weapon_Back", ""],
            },
            {
                "name": "StartShipWeaponConfig",
                "args": ["gun_avenger_gimble", "Weapon_Left", ""],
            },
            {
                "name": "StartShipWeaponConfig",
