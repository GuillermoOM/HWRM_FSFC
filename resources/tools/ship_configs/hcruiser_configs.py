SHI_LILITH = {
    "Ship info": {
        "variables": {
            "displayedName": '"SC Lilith"',
            "sobDescription": '"Heavy Cruiser"',
        },
        "functions": [],
    },
    "Health and Armour": {
    ...
    "Weapons": {
        ...
        "functions": [
            ...
            {
                "name": "StartShipWeaponConfig",
                "args": ["miss_pihrana", "Weapon_Gun7", "Weapon_Gun7"],
            },
            {
                "name": "StartShipWeaponConfig",
                "args": ["miss_pihrana", "Weapon_Gun8", "Weapon_Gun8"],
            },
        ],
    },
    "Latch Points": {
...
TER_LEVIATHAN = {
    ...
    "Movement": {
        "variables": {
            "mass": "31000",
            "thrusterMaxSpeed": "40",
            "mainEngineMaxSpeed": "40",
            "rotationMaxSpeed": "9",
            "thrusterAccelTime": "18",
            "thrusterBrakeTime": "7",
            "mainEngineAccelTime": "18",
            "mainEngineBrakeTime": "7",
            "rotationAccelTime": "9",
            "rotationBrakeTime": "3.5",
        },
        "functions": [],
    },
    "Damage & Death": {
    ...
    "Weapons": {
        ...
        "functions": [
            ...
            {
                "name": "StartShipWeaponConfig",
                "args": ["beam_AABlue", "Weapon_Gun6", ""],
            },
            {
                "name": "StartShipWeaponConfig",
                "args": ["beam_AABlue", "Weapon_Gun7", ""],
            },
            {
                "name": "StartShipWeaponConfig",
