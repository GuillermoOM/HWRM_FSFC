TER_BOANERGES = {
    "Ship info": {
        "variables": {
            "displayedName": '"GTB Boanerges"',
            "sobDescription": '"Heavy Bomber"',
        },
        "functions": [],
    },
    "Health and Armour": {
    ...
    "Movement": {
        "variables": {
            ...
            "rotationAccelTime": "1.1",
            "rotationBrakeTime": "0.55",
        },
        "functions": [],
    },
    "Damage & Death": {
    ...
    "Weapons": {
        ...
        "functions": [
            ...
            {
                "name": "StartShipWeaponConfig",
                "args": ["miss_Helios", "Weapon_Bomb1", ""],
            },
            {
                "name": "StartShipWeaponConfig",
                "args": ["miss_infyrno", "Weapon_Bomb2", ""],
            },
        ],
    },
    "Shields": {
...
TER_MEDUSA = {
    ...
    "Weapons": {
        ...
        "functions": [
            ...
            {
                "name": "StartShipWeaponConfig",
                "args": ["miss_Cyclops", "Weapon_Bomb1", ""],
            },
            {
                "name": "StartShipWeaponConfig",
                "args": ["miss_Cyclops", "Weapon_Bomb2", ""],
            },
            {
                "name": "StartShipWeaponConfig",
                "args": ["gun_prometheusfs1_turret", "Weapon_Laser", ""],
            },
        ],
    },
    "Shields": {
...
VAS_AMUN = {
    ...
    "Movement": {
        "variables": {
            "mass": "800",
            "thrusterMaxSpeed": "160",
            "mainEngineMaxSpeed": "160",
            "rotationMaxSpeed": "60",
            "thrusterAccelTime": "4",
            "thrusterBrakeTime": "2",
            "mainEngineAccelTime": "4",
    ...
    "Weapons": {
        ...
        "functions": [
            ...
            {
                "name": "StartShipWeaponConfig",
                "args": ["miss_harbinger", "Weapon_Bomb1", ""],
            },
            {
                "name": "StartShipWeaponConfig",
                "args": ["miss_harbinger", "Weapon_Bomb2", ""],
            },
            {
                "name": "StartShipWeaponConfig",
                "args": ["miss_infyrno", "Weapon_Bomb2", ""],
            ...
            {
                "name": "StartShipWeaponConfig",
                "args": ["gun_avenger_turret", "Weapon_Turret1", "Fire1"],
            },
            {
                "name": "StartShipWeaponConfig",
                "args": ["gun_avenger_turret", "Weapon_Turret2", "Fire2"],
            },
        ],
    },
    "Shields": {
...
VAS_SEHKMET = {
    ...
    "Movement": {
        "variables": {
            "mass": "700",
            "thrusterMaxSpeed": "248",
            "mainEngineMaxSpeed": "248",
            "rotationMaxSpeed": "90",
            "thrusterAccelTime": "5",
            "thrusterBrakeTime": "2",
    ...
    "Weapons": {
        ...
        "functions": [
            {
                "name": "StartShipWeaponConfig",
                "args": ["gun_prometheusS", "Weapon_FrontGun", ""],
            },
            {
                "name": "StartShipWeaponConfig",
                "args": ["miss_Helios", "Weapon_Bomb1", ""],
