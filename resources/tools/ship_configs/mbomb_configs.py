TER_ARTEMIS = {
    "Ship info": {
        "variables": {
            "displayedName": '"GTB Artemis"',
            "sobDescription": '"Medium Bomber"',
        },
        "functions": [],
    },
    "Health and Armour": {
    ...
    "Movement": {
        "variables": {
            "mass": "450",
            "thrusterMaxSpeed": "260",
            "mainEngineMaxSpeed": "260",
            "rotationMaxSpeed": "76",
            "thrusterAccelTime": "4",
            "thrusterBrakeTime": "2",
    ...
    "Weapons": {
        ...
        "functions": [
            ...
            {
                "name": "StartShipWeaponConfig",
                "args": ["miss_Pihrana", "Weapon_Bomb2", ""],
            },
        ],
    },
    "Shields": {
...
TER_ARTEMISDH = {
    ...
    "Supply": {
        ...
        "functions": [
            {"name": "setSupplyValue", "args": ["Bomber", "3.0"]},
            {"name": "setSupplyValue", "args": ["ArtemisDH", "3.0"]},
        ],
    },
    "Tactics And Multipliers": {
        "variables": {"defaultROE": '"Defensive"', "defaultStance": '"Aggressive"'},
    ...
    "Movement": {
        "variables": {
            "mass": "450",
            "thrusterMaxSpeed": "300",
            "mainEngineMaxSpeed": "300",
            "rotationMaxSpeed": "100",
            "thrusterAccelTime": "4",
            "thrusterBrakeTime": "2",
            "mainEngineAccelTime": "4",
            "mainEngineBrakeTime": "2",
...
TER_ZEUS = {
    ...
    "Movement": {
        "variables": {
            ...
            "rotationMaxSpeed": "85",
            "thrusterAccelTime": "1",
            "thrusterBrakeTime": "0.5",
            "mainEngineAccelTime": "1",
            "mainEngineBrakeTime": "0.5",
    ...
    "Weapons": {
        ...
        "functions": [
            ...
            {
                "name": "StartShipWeaponConfig",
                "args": ["gun_disruptor", "Weapon_FrontGun2", ""],
            },
            {
                "name": "StartShipWeaponConfig",
                "args": ["miss_Cyclops", "Weapon_Bomb1", ""],
...
VAS_OSIRIS = {
    ...
    "Weapons": {
        ...
        "functions": [
            ...
            {
                "name": "StartShipWeaponConfig",
                "args": ["miss_tsunami", "Weapon_Bomb1", ""],
            },
            {
                "name": "StartShipWeaponConfig",
                "args": ["miss_synaptic", "Weapon_Bomb2", ""],
            },
            {
                "name": "StartShipWeaponConfig",
                "args": ["gun_subach_turret", "Weapon_Turret1", ""],
            },
            {
                "name": "StartShipWeaponConfig",
                "args": ["gun_subach_turret", "Weapon_Turret2", ""],
            },
        ],
    },
    "Shields": {
...
SHI_TAURVI = {
    ...
    "Movement": {
        "variables": {
            "mass": "700",
            "thrusterMaxSpeed": "274",
            "mainEngineMaxSpeed": "274",
            "rotationMaxSpeed": "60",
            "thrusterAccelTime": "4.5",
            "thrusterBrakeTime": "2",
            "mainEngineAccelTime": "4.5",
            "mainEngineBrakeTime": "2",
            "rotationAccelTime": "1",
            "rotationBrakeTime": "0.5",
        },
