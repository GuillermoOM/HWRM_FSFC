TER_LOKI = {
    "Ship info": {
        "variables": {"displayedName": '"GTF Loki"', "sobDescription": '"Recon"'},
        "functions": [],
    },
    "Health and Armour": {
        "variables": {
    ...
    "Weapons": {
        ...
        "functions": [
            ...
            {
                "name": "StartShipWeaponConfig",
                "args": ["gun_lamprey", "Weapon_FrontGun2", ""],
            },
            {
                "name": "StartShipWeaponConfig",
            ...
            {
                "name": "StartShipWeaponConfig",
                "args": ["miss_empadv", "Weapon_Missile", ""],
            },
        ],
    },
    "Engines": {
...
SHI_SCORPION = {
    "Ship info": {
        "variables": {"displayedName": '"SF Scorpion"', "sobDescription": '"Recon"'},
        "functions": [],
    },
    "Health and Armour": {
        "variables": {
