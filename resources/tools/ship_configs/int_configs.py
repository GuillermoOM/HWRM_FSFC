TER_PERSEUS = {
    "Ship info": {
        "variables": {
            "displayedName": '"GTF Perseus"',
            "sobDescription": '"Interceptor"',
        },
        "functions": [],
    },
    "Health and Armour": {
    ...
    "Movement": {
        "variables": {
            "mass": "200",
            "thrusterMaxSpeed": "360",
            "mainEngineMaxSpeed": "360",
...
TER_VALKYRIE = {
    ...
    "Movement": {
        "variables": {
            "mass": "200",
            "thrusterMaxSpeed": "370",
            "mainEngineMaxSpeed": "370",
    ...
    "Weapons": {
        ...
        "functions": [
            {
                "name": "StartShipWeaponConfig",
                "args": ["gun_bansheenormal", "Weapon_FrontGun", ""],
            },
            {
                "name": "StartShipWeaponConfig",
            ...
            {
                "name": "StartShipWeaponConfig",
                "args": ["miss_phoenixv", "Weapon_Missile", ""],
            },
        ],
    },
    "Engines": {
...
VAS_SERAPIS = {
    ...
    "Movement": {
        "variables": {
            "mass": "200",
            "thrusterMaxSpeed": "306",
            "mainEngineMaxSpeed": "306",
            "rotationMaxSpeed": "150",
            "thrusterAccelTime": "3",
            "thrusterBrakeTime": "1.5",
    ...
    "Weapons": {
        ...
        "functions": [
            ...
            {
                "name": "StartShipWeaponConfig",
                "args": ["miss_empadv", "Weapon_Missile2", ""],
            },
        ],
    },
    "Engines": {
...
VAS_HORUS = {
    ...
    "Movement": {
        "variables": {
            "mass": "200",
            "thrusterMaxSpeed": "400",
            "mainEngineMaxSpeed": "400",
...
SHI_ASTAROTH = {
    ...
    "Weapons": {
        ...
        "functions": [
            {
                "name": "StartShipWeaponConfig",
                "args": ["gun_shivlightlaser", "Weapon_Gun1", ""],
            },
            {
                "name": "StartShipWeaponConfig",
...
SHI_MANTICORE = {
    ...
    "Movement": {
        "variables": {
            "mass": "200",
            "thrusterMaxSpeed": "414",
            "mainEngineMaxSpeed": "414",
            "rotationMaxSpeed": "113",
            "thrusterAccelTime": "3",
            "thrusterBrakeTime": "1.5",
            "mainEngineAccelTime": "3",
            "mainEngineBrakeTime": "1.5",
