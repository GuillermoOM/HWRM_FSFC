...
String_Properties = {
	...
	path_build = [[data:scripts/races/shivan/scripts/def_build.lua]],
	path_research = [[data:scripts/races/shivan/scripts/def_research.lua]],
	path_ai = [[data:scripts/races/shivan/scripts/def_ai.lua]],
	
	path_ai_special = [[data:scripts/races/shivan/scripts/ai_special.lua]],
	path_ai_research = [[data:scripts/races/shivan/scripts/ai_upgrades.lua]],
	path_ai_subsystems = [[data:scripts/races/shivan/scripts/ai_subsystems.lua]],
	path_ai_build = [[data:scripts/races/shivan/scripts/ai_build.lua]],
