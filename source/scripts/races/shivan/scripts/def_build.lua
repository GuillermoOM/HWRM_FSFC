...
build = {
...

	{
		...
		RequiredResearch = "FighterDesign & AntiFighterMissiles & FS2",
	...
	},
	{
		...
		RequiredResearch = "FighterDesign & MultiroleSwarmMissiles & FS2",
		RequiredShipSubSystems = "Fighterbay",
		DisplayPriority = 8,
	...
	},
	{
		...
		RequiredResearch = "BomberDesign & AntiCruiserBombs & FS2",
		RequiredShipSubSystems = "Fighterbay",
		DisplayPriority = 40,
	...
	},
	{
		...
		RequiredResearch = "CapitalShipDesign & CapitalShipAdvLightBeams & FS2",
	...
	},
	{
		...
		RequiredResearch = "CapitalShipDesign & CapitalShipLightBeams & FS2 & FS1",
		RequiredShipSubSystems = "Communication",
		DisplayPriority = 60,
	...
	},
	{
		...
		RequiredResearch = "CapitalShipDesign & CapitalShipHeavyBeams & FS2 & FS1",
		RequiredShipSubSystems = "Communication",
		DisplayPriority = 65,
	...
	},
	{
		...
		RequiredResearch = "SuperCapitalShipDesign & CapitalShipHeavyBeams & FS2 & FS1",
		RequiredShipSubSystems = "Communication",
		DisplayPriority = 110,
	...
	},
	{
		...
		RequiredResearch = "SuperCapitalShipDesign & CapitalShipHeavyBeams & LuciferBeams & FS2 & FS1",
		RequiredShipSubSystems = "Communication",
		DisplayPriority = 118,
	...
	--        RequiredResearch = "FighterDesign & AdvancedSuperiority & SilentThreat & FS2",
	--        RequiredShipSubSystems = "Fighterbay",
	--        DisplayPriority = 13,
	...
	--        Description = "<b>Description:</b> The first encounter with the SF Gorgon was made by the GTD Saratoga in the Ikeya system.  We are uncertain if this is a new design or if the Shivans have held this particular ship back for the majority of the war. The ship's unusual design not only provides it with exceptional maneuverability, but also allows it to generate an extremely powerful shield.  So far these ships have only been sighted leading wings of lesser fighters, but there have been reports of entire wings of Gorgons in larger forces. \n\n<b>Prerequisites:</b> Fighter Design, Anti-Fighter Missiles, Silent Threat. \n\n<b>Armaments:</b> 4x Medium Laser, 3x Heavy Laser, 1x Anti-Fighter Missile, 1x Swarm Missile.", },
	{
		...
		RequiredResearch = "BomberDesign & FS1AntiCruiserBombs",
		RequiredShipSubSystems = "Fighterbay",
		DisplayPriority = 42,
