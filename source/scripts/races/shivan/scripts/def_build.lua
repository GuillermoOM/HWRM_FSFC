...
build = {
	...
	},
	{
		...
		Description = "<b>Description:</b> The Mephisto freighter behaves much like one of our own, only it is far more powerful and dangerous. Very little data is available on this ship class. \n\n<b>Prerequisites:</b> None. \n\n<b>Armaments:</b> 4x Shivan Turret Laser.",
	},
}
