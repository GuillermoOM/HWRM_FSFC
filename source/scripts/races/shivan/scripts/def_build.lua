...
build = {
	...
	-- Fighters
	{
		...
		DisplayPriority = 1,
		DisplayedName = "SF Scorpion - Recon <c=12AB06>40s</c>",
	...
	},
	{
		...
		RequiredShipSubSystems = "",
		DisplayPriority = 1,
		DisplayedName = "SF Astaroth - Scout <c=12AB06>40s</c>",
	...
	},
	{
		...
		RequiredShipSubSystems = "",
		DisplayPriority = 2,
		DisplayedName = "SF Manticore - Interceptor <c=12AB06>40s</c>",
	...
	},
	{
		...
		RequiredShipSubSystems = "",
		DisplayPriority = 3,
		DisplayedName = "SF Dragon - Superiority <c=12AB06>45s</c>",
	...
	},
	{
		...
		RequiredShipSubSystems = "",
		DisplayPriority = 4,
		DisplayedName = "SF Basilisk - Assault <c=12AB06>40s</c>",
	...
	},
	{
		...
		RequiredShipSubSystems = "",
		DisplayPriority = 5,
		DisplayedName = "SF Gorgon - Heavy Assault <c=12AB06>40s</c>",
	...
	},
	{
		...
		RequiredShipSubSystems = "",
		DisplayPriority = 6,
		DisplayedName = "SF Mara - Adv. Superiority <c=12AB06>45s</c>",
	...
	},
	{
		...
		RequiredShipSubSystems = "",
		DisplayPriority = 7,
		DisplayedName = "SF Aeshma - Assault <c=12AB06>40s</c>",
...

	{
		...
		RequiredShipSubSystems = "",
		DisplayPriority = 1,
		DisplayedName = "SB Shaitan - Strike Bomber <c=12AB06>50s</c>",
	...
	},
	{
		...
		RequiredShipSubSystems = "",
		DisplayPriority = 2,
		DisplayedName = "SB Nahema - Strike Bomber <c=12AB06>50s</c>",
	...
	},
	{
		...
		RequiredShipSubSystems = "",
		DisplayPriority = 3,
		DisplayedName = "SB Taurvi - Medium Bomber <c=12AB06>50s</c>",
	...
	},
	{
		...
		RequiredShipSubSystems = "",
		DisplayPriority = 4,
		DisplayedName = "SB Nephilim - Heavy Bomber <c=12AB06>50s</c>",
	...
	},
	{
		...
		RequiredShipSubSystems = "",
		DisplayPriority = 5,
		DisplayedName = "SB Seraphim - Heavy Bomber <c=12AB06>60s</c>",
	...
	-- Cruisers
	{
		...
		RequiredShipSubSystems = "",
		DisplayPriority = 1,
		DisplayedName = "SC Cain (FS1) - Strike Cruiser <c=12AB06>60s</c>",
	...
	},
	{
		...
		RequiredShipSubSystems = "",
		DisplayPriority = 1,
		DisplayedName = "SC Cain - Strike Cruiser <c=12AB06>60s</c>",
	...
	},
	{
		...
		RequiredShipSubSystems = "",
		DisplayPriority = 2,
		DisplayedName = "SC Lilith (FS1) - Heavy Cruiser <c=12AB06>80s</c>",
	...
	},
	{
		...
		RequiredShipSubSystems = "",
		DisplayPriority = 2,
		DisplayedName = "SC Lilith - Heavy Cruiser <c=12AB06>80s</c>",
...

	{
		...
		RequiredShipSubSystems = "",
		DisplayPriority = 3,
		DisplayedName = "SC Rakshasa - Adv. Cruiser <c=12AB06>80s</c>",
	...
	-- Capital Ships
	{
		...
		RequiredShipSubSystems = "",
		DisplayPriority = 1,
		DisplayedName = "SCv Moloch - Corvette <c=12AB06>120s</c>",
	...
	},
	{
		...
		RequiredShipSubSystems = "",
		DisplayPriority = 2,
		DisplayedName = "SD Demon (FS1) - Destroyer <c=12AB06>180s</c>",
	...
	},
	{
		...
		RequiredShipSubSystems = "",
		DisplayPriority = 2,
		DisplayedName = "SD Demon - Destroyer <c=12AB06>180s</c>",
		Description = "<b>Description:</b> The SD Demon class of Shivan destroyers is much smaller than the Lucifer class but very heavily armed and extremely dangerous. Demons are known to carry numerous wings of fighters and bombers. \n\n<b>Good Against:</b> Cruisers, Corvettes, Capital Ships \n<b>Weak Against:</b> Bombers, Super Destroyers \n\n<b>Prerequisites:</b> Capital Ship Design, Demon. \n\n<b>Armaments:</b> 2x Shivan Light Laser Turret, 5x Shivmegafunk Turret, 14x Shivan Super Laser Turret, 5x Fighterkiller.",
	},
	{
		Type = Ship,
		...
		RequiredShipSubSystems = "",
		DisplayPriority = 3,
		DisplayedName = "SD Ravana - Destroyer <c=12AB06>140s</c>",
	...
	},
	{
		...
		RequiredShipSubSystems = "",
		DisplayPriority = 4,
		DisplayedName = "SD Lucifer - Super Destroyer <c=12AB06>240s</c>",
	...
	},
	{
		...
		RequiredShipSubSystems = "",
		DisplayPriority = 5,
		DisplayedName = "SJ Sathanas <c=12AB06>300s</c>",
	...
	-- Platform
	{
		...
		RequiredShipSubSystems = "",
		DisplayPriority = 1,
		DisplayedName = "SSG Trident - Sentry Gun <c=12AB06>40s</c>",
	...
	},
	{
		...
		RequiredShipSubSystems = "",
		DisplayPriority = 2,
		DisplayedName = "SSG Belial - Sentry Gun <c=12AB06>20s</c>",
	...
	},
	{
		...
		RequiredShipSubSystems = "",
		DisplayPriority = 3,
		DisplayedName = "SFr Mephisto - Sentry Builder <c=12AB06>20s</c>",
	...
	-- Utility
	{
		...
		RequiredShipSubSystems = "",
		DisplayPriority = 1,
		DisplayedName = "ST Azrael - Collector <c=12AB06>40s</c>",
	...
	},
	{
		...
		RequiredShipSubSystems = "",
		DisplayPriority = 2,
		DisplayedName = "SG Rahu - Drop-off <c=12AB06>40s</c>",
...

	{
		...
		RequiredShipSubSystems = "",
		DisplayPriority = 3,
		DisplayedName = "SFr Asmodeus - Repair <c=12AB06>50s</c>",
	...
	},
	{
		...
		RequiredShipSubSystems = "",
		DisplayPriority = 4,
		DisplayedName = "Shivan Comm Node - AWACS <c=12AB06>50s</c>",
