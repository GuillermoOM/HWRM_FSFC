...
String_Properties = {
	...
	path_ai = [[data:scripts/races/terran/scripts/def_ai.lua]],
	
	path_ai_special = [[data:scripts/races/terran/scripts/ai_special.lua]],
	path_ai_research = [[data:scripts/races/terran/scripts/ai_upgrades.lua]],
	path_ai_subsystems = [[data:scripts/races/terran/scripts/ai_subsystems.lua]],
	path_ai_build = [[data:scripts/races/terran/scripts/ai_build.lua]],
