...
build = {
	{
		Type = SubSystem,
		ThingToBuild = "ter_orionhugeflak",
		RequiredResearch = "",
		RequiredShipSubSystems = "",
		DisplayPriority = 13,
		DisplayedName = "Heavy Flak Upgrade",
		Description = "<b>Orion Heavy Flak Upgrade</b> \n\n<b>Description:</b> During the war, a number of GTVA and NTF Orions were refitted with Heavy Flak turrets in lieu of their traditional Huge Turrets. These had a marked increase in defensive capabilities against strike craft, while the Orion's heavy beam broadside was still capable of dealing with enemy warships. \n\n<b>Prerequisites:</b> Capital Ship Design or Fast Tracking Turrets",
	},
...

	{
		...
		RequiredShipSubSystems = "Fighterbayfs1",
		DisplayPriority = 1,
	...
	},
	{
		...
		RequiredShipSubSystems = "Fighterbay | Fighterbayfs1",
		DisplayPriority = 7,
	...
	},
	{
		...
		RequiredResearch = "FighterDesign & TornadoMissiles & AntiBomberMissiles & FS2",
	...
	},
	{
		...
		RequiredResearch = "FighterDesign & MultiRoleSwarmMissiles & AntiFighterMissiles & FS2",
		RequiredShipSubSystems = "Fighterbay",
		DisplayPriority = 8,
	...
	},
	{
		...
		RequiredResearch = "BomberDesign & AntiCruiserBombs & ArtemisDH & FS2",
		RequiredShipSubSystems = "Fighterbay | Fighterbayfs1",
		DisplayPriority = 109,
	...
	},
	{
		...
		RequiredResearch = "CapitalShipDesign & CapitalShipLightBeams & CruiserHealthUpgrade & FS2 & FS1",
		RequiredShipSubSystems = "Communication",
		DisplayPriority = 225,
	...
	},
	{
		...
		RequiredResearch = "SuperCapitalShipDesign & CapitalShipAdvHeavyBeams & FS2",
		RequiredShipSubSystems = "Communication",
		DisplayPriority = 340,
...

	{
		...
		RequiredShipSubSystems = "Communication & GTA",
		DisplayPriority = 350,
	...
	},
	{
		...
		RequiredShipSubSystems = "FighterbayFS1 | Fighterbay",
		DisplayPriority = 508,
	...
	},
	{
		...
		RequiredResearch = "FighterDesign & FS1AntiBomberMissiles",
		RequiredShipSubSystems = "Fighterbay",
		DisplayPriority = 61,
