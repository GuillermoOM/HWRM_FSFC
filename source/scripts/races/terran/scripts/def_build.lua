...
build = {
...

	{
		...
		Description = "<b>Description:</b> The GTF Ares class of fighters is a radical upgrade of the Hercules II fighter. The power plant has been completely replaced with the newer, more powerful Nankam NA-27f model. Depleted uranium shielding has been added atop critical subsystems, making the Ares harder to incapacitate. Two primary weapon banks have been added, for greater firepower than the Herc II. This greater punch and protection come at a cost, however, as the Ares handles like a potato. \n\n<b>Prerequisites:</b> Fighter Design, Anti-Bomber Missiles, Tornado missiles. \n\n<b>Armaments:</b> 2x GTW-66 Maxim, 4x Prometheus S, 2x GTM-55 Trebuchet, 2x GTM-4a Tornado.",
	},
...

	{
		...
		Description = "<b>Description:</b> Developed in a joint operation by the Vasudan and Terran governments, the GTF Ulysses is an excellent all-around fighter. It offers superior maneuverability and a high top speed. \n\n<b>Prerequisites:</b> Fighter Design, Anti-Fighter Missiles. \n\n<b>Armaments:</b> 4x GTW-15 Avenger, 2x GTW-99 Shield Breaker (Silent Threat Upgrade), 1x GTM-9 Interceptor.",
	},
...

	{
		...
		Description = "<b>Description:</b> The Ursa is the first bomber designed specifically for the purpose of annihilating capital ships. It carries a massive payload and is the only bomber in the GTA which can equip the Harbinger Bomb. Strong shielding and hull make the Ursa very difficult to destroy. \n\n<b>Prerequisites:</b> Bomber Design, Anti Capital Bombs. \n\n<b>Armaments:</b> 5x GTW-5 Prometheus, 1x Banshee turret, 1x GTM-N1 Harbinger, 1x GTM-86 Cluster Bomb (Silent Threat Upgrade).",
	},
	...
	},
	{
		...
		RequiredShipSubSystems = "",
		DisplayPriority = 6,
		DisplayedName = "NTF Iceni - Command Corvette <c=12AB06>210s</c>",
		Description = "<b>Description:</b> The Iceni is the NTF command frigate, built under Admiral Bosch's direction at the Freedom shipyards in Polaris, captured by the Neo-Terran Front at the start of their rebellion. With over two dozen turrets and a sheath of ultra-dense depleted uranium shielding around its subsystems, the Iceni is an extremely tough nut to crack. With Bosch on board, providing tactical guidance, the Iceni is the equal of any GTVA battle group. \n\n<b>Prerequisites:</b> Corvette Armor Upgrade, Heavy Photon Beams, Corvette Sprint Drive. \n\n<b>Armaments:</b> 4x Heavy Beam, 4x Anti-Fighter Beam, 2x Flak Turret, 6x Huge Turret, 6x Turret, 2x Fighterkiller, 1x Pihrana Launcher.",
	},
	{
		Type = Ship,
	...
	},
	{
		...
		Description = "<b>Description:</b> The Faustus Science vessel was, and still is, a civilian craft. However, in the 14 years since the Terran-Vasudan war began, more and more of these were commissioned by the GTA in order to pursue military research. However, its obvious value, poor fighting capabilities, and lack of speed make it a prime target for enemy ships; hence, you will rarely find many of these anywhere near the front lines of battle. \n\n<b>Prerequisites:</b> Cruiser design \n\n<b>Armaments:</b> 6x Turret.",
	},
	{
		Type = Ship,
