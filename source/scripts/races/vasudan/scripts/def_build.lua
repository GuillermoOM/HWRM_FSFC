...
build = {
	...
	},
	{
		...
		Description = "<b>Description:</b> The gargantuan Karnak installation is the Vasudans' answer to the GTI Arcadia.  This monstrous facility bristles with dozens of turrets and can house up to two full squadrons of fighters.  Its primary purpose is to serve as a construction and maintenance yard for the Vasudan fleets. \n\n<b>Prerequisites:</b> None. \n\n<b>Armaments:</b> 20x Turret, 17x Fighterkiller.",
	},
	{
		Type = Ship,
	...
	-- Platforms --------------
	{
		...
		Description = "<b>Description:</b> The Ankh is the standard Vasudan sentry gun. Its most common usage is guarding supply depots. However, since the development of the Anubis, its usage has dropped off significantly. \n\n<b>Prerequisites:</b> None. \n\n<b>Armaments:</b> 2x Turret.",
	},
	{
		Type = Ship,
	...
	},
	{
		...
		Description = "<b>Description:</b> The PVSC Imhotep is a state-of-the-art deep space laboratory and research vessel. Designed to maximise adaptability, the Imhotep's modular laboratories can be quickly reconfigured with scientific equipment suited to the task at hand. Since less laboratory space is required, internal volume is freed up on the lower decks for a small podbay housing four remote research pods. Not unexpectedly, Imhotep class vessels are poorly armed and fragile, requiring assiduous protection if they should ever be found in a battle zone. \n\n<b>Prerequisites:</b> Cruiser Design \n\n<b>Armaments:</b> 2x Turret, 2x Avenger, 1x Fighterkiller.",
	},
	{
		Type = Ship,
		...
		Description = "<b>Description:</b> The Bast freighter is unarmed, and considered a non threat. We believe that it is mainly used by Vasudan civilians, but we have seen some in front line operations. It has very low target value, but should be destroyed, as any kind of resupply ship is a danger to the GTA. \n\n<b>Prerequisites:</b> None. \n\n<b>Armaments:</b> None.",
	},
	{
		Type = Ship,
		...
		Description = "<b>Description:</b> With three turrets, the Ma'at is a hairy target for GTA pilots to attack. However, it is slow enough that it can be destroyed with enough patience. As always, supply ships for the PVN are considered to be valid targets. \n\n<b>Prerequisites:</b> None. \n\n<b>Armaments:</b> 3x Turret.",
	},
	{
		Type = Ship,
		...
		Description = "<b>Description:</b> Long range sensor device. \n\n<b>Prerequisites:</b> None. \n\n<b>Armaments:</b> None.",
	},
	{
		Type = Ship,
		...
		Description = "<b>Description:</b> The GVS Nephtys is the Vasudans' new support ship. It is fast and maneuverable, a necessity when trying to dock with fighters in the heat of battle. Mekhu Enterprises built a cargo bay into the rear of the ship, enabling it to carry extra supplies and munitions during emergencies. Mekhu Enterprises licensed the GTS Hygeia's magnetic-stasis delivery system from Triton Dynamics, so both ships are equally adept at re-supplying combat craft with missiles and bombs. The high number of warheads carried by the Nephtys makes it a dangerous ship to be near when it blows up. \n\n<b>Prerequisites:</b> Fighter Design or Bomber Design \n\n<b>Armaments:</b> None.",
	},
	{
		Type = Ship,
		...
		Description = "<b>Description:</b> The GVA Setekh is the Vasudan class of AWACS vessels, comparable to the Terran GTA Charybdis class. Setekhs are smaller, less heavily armored, and have half the turrets of Charybdis ships. Despite these shortcomings, the Vasudan navy insists upon deploying Setekhs in Vasudan battle groups, claiming the Vasudan versions are more appropriate for their fleets. Setekhs' crystalline detection arrays provide their fleets with doubled radar range within the nebular region. Every Vasudan battle group operating in this theatre has a wing of Setekhs attached to it. \n\n<b>Prerequisites:</b> AWACS Level I \n\n<b>Armaments:</b> 3x Turret.",
	},
	{
		Type = Ship,
	...
	},
	{
		...
		Description = "<b>Description:</b> The GVT Isis is most often used as a military personnel transport but also occasionally serves as a repair ship or even a tugboat, helping to maneuver large vessels into docking bays. Two cannon turrets and thick molybdenum plating serve to protect its cargo. Magnetic cargo locks located on the Isis's undercarriage enable it to transport small cargo containers of supplies and munitions in emergencies. \n\n<b>Prerequisites:</b> None. \n\n<b>Armaments:</b> None.",
	},
}
