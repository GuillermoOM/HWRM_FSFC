...
build = {
	...
	-- Fighters
	{
		...
		Description = "<b>Description:</b> The PVF Anubis is a Great War-era Space Superiority fighter of the Vasudan Navy. Boasting high speed and maneuverability, the Anubis is capable of engaging and eliminating any Shivan fighter threat. Equipped with an afterburner and robust weapons mounts, it is a versatile assault platform. \n\n<b>Good Against:</b> Fighters, Bombers \n<b>Weak Against:</b> Corvettes, Capital Ships \n\n<b>Prerequisites:</b> Fighter Design, Anubis. \n\n<b>Armaments:</b> 1x Vll9, 1x Rockeye.",
	},
	{
		Type = Ship,
	...
	},
	{
		...
		RequiredShipSubSystems = "",
		DisplayPriority = 3,
		DisplayedName = "GVF Horus - Interceptor <c=12AB06>40s</c>",
	...
	},
	{
		...
		RequiredShipSubSystems = "",
		DisplayPriority = 6,
		DisplayedName = "GVF Tauret - Heavy Assault <c=12AB06>45s</c>",
	...
	},
	{
		...
		RequiredShipSubSystems = "",
		DisplayPriority = 7,
		DisplayedName = "GVF Ptah - Stealth Recon <c=12AB06>30s</c>",
	...
	-- Bombers ---------------
	{
		...
		RequiredShipSubSystems = "",
		DisplayPriority = 1,
		DisplayedName = "GVB Osiris - Reserve Bomber <c=12AB06>50s</c>",
	...
	},
	{
		...
		RequiredShipSubSystems = "",
		DisplayPriority = 3,
		DisplayedName = "GVB Bakha - Strike Bomber <c=12AB06>40s</c>",
	...
	},
	{
		...
		RequiredShipSubSystems = "",
		DisplayPriority = 4,
		DisplayedName = "GVB Sehkmet - Heavy Bomber <c=12AB06>60s</c>",
	...
	-- Cruisers
	{
		...
		RequiredShipSubSystems = "",
		DisplayPriority = 1,
		DisplayedName = "GVC Aten (FS1) - Reserve Cruiser <c=12AB06>60s</c>",
	...
	},
	{
		...
		RequiredShipSubSystems = "",
		DisplayPriority = 2,
		DisplayedName = "GVC Aten - Reserve Cruiser <c=12AB06>60s</c>",
	...
	},
	{
		...
		RequiredShipSubSystems = "",
		DisplayPriority = 3,
		DisplayedName = "GVC Mentu - Advanced Cruiser <c=12AB06>80s</c>",
	...
	-- Capital Ships
	{
		...
		RequiredShipSubSystems = "",
		DisplayPriority = 1,
		DisplayedName = "GVCv Sobek - Corvette <c=12AB06>120s</c>",
	...
	},
	{
		...
		RequiredShipSubSystems = "",
		DisplayPriority = 2,
		DisplayedName = "GVD Typhon (FS1) - Destroyer <c=12AB06>180s</c>",
	...
	},
	{
		...
		RequiredShipSubSystems = "",
		DisplayPriority = 2,
		DisplayedName = "GVD Typhon - Destroyer <c=12AB06>180s</c>",
	...
	},
	{
		...
		RequiredShipSubSystems = "",
		DisplayPriority = 4,
		DisplayedName = "PVI Karnak - Installation <c=12AB06>180s</c>",
	...
	},
	{
		...
		Description = "<b>Description:</b> The Great War (FS1) variant of the GVD Hatshepsut class flagship, commissioned to serve as the ultimate Vasudan command ship during the conflict against the Shivans. Lacking the beam technology of the later reconstruction era, this massive vessel relies on an extensive network of heavy kinetic turrets, rapid-fire lasers, flak guns, and blue flux torpedoes. It is a direct match for the heaviest Terran and Shivan capital threats. \n\n<b>Good Against:</b> Cruisers, Corvettes, Capital Ships \n<b>Weak Against:</b> Bombers, Super Destroyers \n\n<b>Prerequisites:</b> Capital Ship Design, Hatshepsut (FS1). \n\n<b>Armaments:</b> 4x Vasudan Huge Turret, 5x Fluxcannon, 1x Heavyflak Turret, 2x Vasudan Laser Gimble, 6x Vasudan Huge Gimble, 12x Flak Gimble.",
	},
	{
		Type = Ship,
	...
	},
	{
		...
		RequiredShipSubSystems = "",
		DisplayPriority = 1,
		DisplayedName = "GVSG Edjo - Sentry Gun <c=12AB06>20s</c>",
	...
	},
	{
		...
		RequiredShipSubSystems = "",
		DisplayPriority = 2,
		DisplayedName = "GVFr Bes - Sentry Builder <c=12AB06>40s</c>",
	...
	},
	{
		...
		RequiredShipSubSystems = "",
		DisplayPriority = 3,
		DisplayedName = "PVFr Ma'at - Sentry Builder <c=12AB06>25s</c>",
	...
	},
	{
		...
		RequiredShipSubSystems = "",
		DisplayPriority = 2,
		DisplayedName = "GVG Anuket - Drop-off <c=12AB06>40s</c>",
	...
	},
	{
		...
		RequiredShipSubSystems = "",
		DisplayPriority = 3,
		DisplayedName = "GVS Nephthys - Support Ship <c=12AB06>20s</c>",
	...
	},
	{
		...
		RequiredShipSubSystems = "",
		DisplayPriority = 4,
		DisplayedName = "GVFr Satis - Repair <c=12AB06>50s</c>",
	...
	},
	{
		...
		Description = "<b>Description:</b> The Bast is a support frigate. It is primarily used for repairing allied vessels, but can be used for other support roles. \n\n<b>Good Against:</b> None \n<b>Weak Against:</b> Everything \n\n<b>Prerequisites:</b> Repair Bast. \n\n<b>Armaments:</b> 3x Subach Turret.",
	},
	{
		Type = Ship,
	...
	},
	{
		...
		RequiredShipSubSystems = "",
		DisplayPriority = 5,
		DisplayedName = "GVA Setekh - AWACS <c=12AB06>50s</c>",
