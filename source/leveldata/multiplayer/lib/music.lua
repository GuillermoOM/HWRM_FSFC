...
function RandomMusicRuleFS2()
	...
	--Once we've reached the end of our track, we generate a new track, play it, and reset our timer to 0.
		if m_timer > track_length then
			...
			m_timer = 0
			musictype = 0
			print("Now continuing ambient music with track title: "..track_title.." and track length: "..track_length..".")
		end
	...
	--WE FORCE THIS CHANGE EVEN IF THE CURRENT TRACK IS STILL PLAYING
		...
		m_timer = 0
		musictype = 3	
		print("Now playing victory music with track title: "..track_title.." and track length: "..track_length..".")
	...
	--We're still in combat, so play a new combat track.
		if m_timer > track_length then
			...
			m_timer = 0
			musictype = 1
			print("Now continuing battle music with track title: "..track_title.." and track length: "..track_length..".")
		end
	...
	--We're now in combat, so play the appopriate enemy arrival music. 
		...
		m_timer = 0
		musictype = 2	
		print("now playing combat start music with track title: "..track_title.." and track length: "..track_length..".")
	end
