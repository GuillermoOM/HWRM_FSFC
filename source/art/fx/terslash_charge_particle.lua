fx = {
	...
	properties = {
		...
		property_22 = { name = "Mesh", type = "VARTYPE_STRING", value = "Data:art/fx/box.hod" },
		property_21 = { name = "Texture", type = "VARTYPE_STRING", value = "DATA:ART/FX/BEAM/beam_green_glow.anim" },
		property_11 = { name = "SpinRandom", type = "VARTYPE_BOOL", value = 1 },
		property_15 = { name = "UseDepthSort", type = "VARTYPE_BOOL", value = 0 },
		...
		property_03 = { name = "SpinY", type = "VARTYPE_ARRAY_TIMEFLOAT", value = { 0, 0.53333, 1, 8.53333 }, },
		property_06 = { name = "RadiusEpsilon", type = "VARTYPE_FLOAT", value = 0 },
		property_05 = { name = "Colour", type = "VARTYPE_ARRAY_TIMECOLOUR", value = { entry_02 = { 1, 0, 0, 0, 1 }, entry_00 = { 0, 1, 1, 1, 1 }, entry_01 = { 0.80597, 1, 1, 1, 1 }, }, },
		property_08 = { name = "SpinEpsilonX", type = "VARTYPE_FLOAT", value = 0 },
		property_07 = { name = "RateEpsilon", type = "VARTYPE_FLOAT", value = 0 },
		property_02 = { name = "SpinX", type = "VARTYPE_ARRAY_TIMEFLOAT", value = { 0, 1.6, 1, 32 }, },
		...
		property_12 = { name = "Duration", type = "VARTYPE_FLOAT", value = 6.5 },
		property_00 = {
			name = "Radius",
