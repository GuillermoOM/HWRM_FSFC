fx = {
	...
	properties = {
		...
		property_21 = { name = "Texture", type = "VARTYPE_STRING", value = "DATA:ART/FX/shockwave/shockwave01capship.ANIM" },
		property_12 = { name = "Duration", type = "VARTYPE_FLOAT", value = 4.26 },
		property_00 = {
			name = "Radius",
