fx = {
	style = "STYLE_RING",
	properties = {
		property_25 = { name = "SortOrder", type = "VARTYPE_INT", value = 0 },
		property_24 = { name = "RandomBitmap", type = "VARTYPE_BOOL", value = 0 },
		property_23 = { name = "BirthSpawn_Fx", type = "VARTYPE_STRING", value = "muzzle_spittle_spray" },
		...
		property_21 = { name = "Texture", type = "VARTYPE_STRING", value = "DATA:ART/FX/shockwave/shockwave01megabomb.ANIM" },
		property_12 = { name = "Duration", type = "VARTYPE_FLOAT", value = 3.26 },
		property_00 = {
			name = "Radius",
