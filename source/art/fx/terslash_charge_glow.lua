fx = {
	...
	properties = {
		...
		property_26 = { name = "SortOrder", type = "VARTYPE_INT", value = 3 },
		...
		property_21 = { name = "Texture", type = "VARTYPE_STRING", value = "DATA:ART/FX/Beam_Charge/BIG_FLASH_RING_Green.TGA" },
		...
		property_05 = { name = "Colour", type = "VARTYPE_ARRAY_TIMECOLOUR", value = { entry_00 = { 0, 0, 0, 0, 0 }, entry_01 = { 0.42687, 0, 0, 0, 0 }, entry_02 = { 0.44328, 1, 1, 1, 0 }, entry_03 = { 0.84478, 0, 0, 0, 0 }, entry_04 = { 1, 0, 0, 0, 0 }, }, },
		...
		property_12 = { name = "Duration", type = "VARTYPE_FLOAT", value = 4.5 },
		property_00 = {
			name = "Radius",
