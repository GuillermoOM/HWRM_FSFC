fx = {
	...
	properties = {
		...
		property_21 = { name = "Texture", type = "VARTYPE_STRING", value = "DATA:ART/FX/MUZZLE_FLASHES/FIERY_HEAD_RING_white.TGA" },
		...
		property_05 = { name = "Colour", type = "VARTYPE_ARRAY_TIMECOLOUR", value = { entry_00 = { 0, 1, 0, 0.2118, 0.1 }, entry_01 = { 0, 1, 0, 0.2118, 0.1 }, }, },
		property_08 = { name = "SpinEpsilonX", type = "VARTYPE_FLOAT", value = 0 },
		property_07 = { name = "RateEpsilon", type = "VARTYPE_FLOAT", value = 0.5 },
		...
		property_00 = { name = "Radius", type = "VARTYPE_ARRAY_TIMEFLOAT", value = { 0, 0, 1, 1 }, },
